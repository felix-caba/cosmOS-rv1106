...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "arm-rockchip830-linux-uclibcgnueabihf-",
  CXX => "g++",
  CXXFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  LDLIBS => [ "-latomic", "-lpthread" ],
  PERL => "/usr/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  RCFLAGS => [  ],
  ...
  openssldir => "",
  options => "-latomic -lpthread enable-threads enable-shared enable-camellia enable-mdc2 enable-zlib --prefix=/home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/out no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "linux-armv4", "-latomic", "-lpthread", "threads", "shared", "no-rc5", "enable-camellia", "enable-mdc2", "no-tests", "no-fuzz-libfuzzer", "no-fuzz-afl", "zlib", "--prefix=/home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/out" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/home/cosmOS-rv1106/sysdrv/tools/board/toolkits/openssl/out",
  processor => "",
